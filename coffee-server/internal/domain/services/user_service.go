...
func (s *UserService) GetUsers (ctx context.Context, logger *zerolog.Logger) (*entity.User, error) {
	return s.repo.GetAllAccounts(ctx, logger); 
}

func (s *UserService) InsertUser (ctx context.Context, logger *zerolog.Logger, userAccount *entity.User) error {
